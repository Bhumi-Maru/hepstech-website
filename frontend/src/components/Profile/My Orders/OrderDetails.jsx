        ...
        <div class="md:col-span-3">
          ...
          <div class="mt-3 lg:flex lg:items-center lg:justify-between">
            <div class="sm:flex sm:items-center">
              <h1 class="text-2xl font-bold text-gray-900">Order ID: {id}</h1>
          ...
          <div class="grid grid-cols-1 mt-12 lg:grid-cols-6 lg:gap-x-8 gap-y-10">
            <div class="lg:col-span-4">
              ...
              <div>
                ...
                <p class="mt-1.5 font-medium">
                  Proin sodales placerat sollicitudin. Donec fringilla, ante nec
                  consectetur placerat, velit libero cursus risus, sit amet
                  hendrerit velit enim non leo.
                </p>
              </div>
            </div>
