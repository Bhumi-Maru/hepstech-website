      ...
      <section class="section-slider">
        <div class="container">
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold">Best Selling Sale 04</h2>
          ...
          <div class="relative mt-3">
            <div
              class="swiper-button-prev swiper-button-custom swiper-button-inside swiper-button-best-selling-six-04"
              style={{ display: "none" }}
            ></div>

            <div class="swiper-container swiper-best-selling-six-04">
            ...
            <div
              class="swiper-button-next swiper-button-custom swiper-button-inside swiper-button-best-selling-six-04"
              style={{ display: "none" }}
            ></div>
          </div>
        </div>
