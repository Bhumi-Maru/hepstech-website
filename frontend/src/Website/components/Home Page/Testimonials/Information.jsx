          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8">
            <div className="flex items-start">
              <img
                ...
                src="../website_assets/images/truck.png"
                alt=""
              />
              <div className="ml-4">
            ...
            <div className="flex items-start">
              <img
                className="flex-none w-8 h-8"
                src="../website_assets/images/support.png"
                alt=""
              />
              <div className="ml-4">
            ...
            <div className="flex items-start">
              <img
                className="flex-none w-8 h-8"
                src="../website_assets/images/refresh.png"
                alt=""
              />
              <div className="ml-4">
            ...
            <div className="flex items-start">
              <img
                className="flex-none w-8 h-8"
                src="../website_assets/images/shield-check.png"
                alt=""
              />
              <div className="ml-4">
