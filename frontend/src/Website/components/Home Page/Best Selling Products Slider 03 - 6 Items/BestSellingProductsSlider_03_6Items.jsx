...
export default function BestSellingProductsSlider_03_6Items({
  ...
  useEffect(() => {
    if (section17Products.length > 0) {
      // Show navigation only if we have more products than what we're displaying
      setShowNavigation(section17Products.length > productsToShow);

      new Swiper(".swiper-best-selling-six-03", {
        slidesPerView: productsToShow,
        spaceBetween: 10,
        navigation: showNavigation
          ? {
              nextEl: ".swiper-button-next.swiper-button-best-selling-six-03",
              prevEl: ".swiper-button-prev.swiper-button-best-selling-six-03",
            }
          : {},
        breakpoints: {
          320: { slidesPerView: 1 },
  ...
  }, [section17Products, productsToShow, showNavigation]);
  ...
  const displayedProducts = section17Products.slice(
    0,
    Math.max(productsToShow, section17Products.length)
  );
      ...
      <section class="section-slider">
        <div class="container">
          ...
          <div class="relative mt-3">
            {showNavigation && (
              <div class="swiper-button-prev swiper-button-custom swiper-button-inside swiper-button-best-selling-six-03 swiper-button-disabled"></div>
            )}
            ...
            {showNavigation && (
              <div class="swiper-button-next swiper-button-custom swiper-button-inside swiper-button-best-selling-six-03 swiper-button-disabled"></div>
            )}
          </div>
        </div>
      </section>
