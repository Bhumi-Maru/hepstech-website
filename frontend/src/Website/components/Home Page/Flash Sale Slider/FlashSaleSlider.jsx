...
export default function FlashSaleSlider({ setIsAddToCartModal }) {
  ...
  }, [section4Products, productsToShow, showNavigation]);
  ...
  const displayedProducts = section4Products.slice(
    0,
    Math.max(productsToShow, section4Products.length)
  );
        ...
        <div className="relative mt-4">
          ...
          <div className="swiper-container swiper-flash-sale">
            <div
              ...
              //   gap: "10px",
              //   height: "350px",
              //   // "--slides-per-view": productsToShow,
              // }}
            >
