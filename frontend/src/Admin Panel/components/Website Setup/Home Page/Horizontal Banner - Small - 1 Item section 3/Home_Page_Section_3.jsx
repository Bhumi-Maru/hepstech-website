...
export default function Home_Page_Section_3() {
  ...
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 3
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 3, // ✅ This should be 3 for section 3
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      horizontal_Banner_Small_1_Item_section_3: true,
    }));
  };
    ...
    <div className="px-4 py-5 bg-white rounded-lg shadow sm:p-6">
      <div className="flex items-center justify-between space-x-8">
        ...
        <div className="flex-shrink-0 ml-4 toggle-switch">
          ...
          />
          <label htmlFor="horizontalSingleBanner01Status"></label>
        </div>
      </div>
