...
export default function Add_Main_Banner_Section_3_Popup_Modal() {
  const { setIsOpenPopupModal, isOpenPopupModal } = useAdminGlobalContext();
  return (
    <>
      {/* [HOME PAGE SECTION 3] ADD MAIN BANNER IN SECTION 3   */}
      <div
        className={`modal ${
        ...
        id="horizontal_Banner_Small_1_Item_section_3"
        tabindex="-1"
        role="dialog"
        aria-hidden="false"
      >
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      ...
                      <span
                        ...
                        dir="ltr"
                        data-select2-id="select2-data-5-k8sn"
                        style={{ width: "502px" }}
                      >
