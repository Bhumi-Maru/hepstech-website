...
export default function Home_Page_Section_8() {
  ...
  // Filter banners for layoutNumber 8
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 8
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 8, // ✅ This should be 8 for section 8
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      horizontal_Banners_Large_2_Items: true,
    }));
  };
        ...
        <div className="flex items-center justify-between space-x-8">
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            <input
              ...
              role="checkbox"
              tabIndex="0"
              checked={toggleStates.horizontal_Banners_Large_2_Items}
              onChange={() => handleToggle("horizontal_Banners_Large_2_Items")}
            />
            <label htmlFor="horizontalBanners03Status"></label>
          </div>
        </div>

        {toggleStates.horizontal_Banners_Large_2_Items && (
          <>
            <div className="mt-4" id="horizontalBanners03Content">
