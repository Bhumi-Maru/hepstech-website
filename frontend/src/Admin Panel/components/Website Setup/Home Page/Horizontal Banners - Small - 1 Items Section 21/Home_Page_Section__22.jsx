...
export default function Home_Page_Section__22() {
  ...
  // Filter banners for layoutNumber 1
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 22
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 22, // ✅ This should be 22 for section 22
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      horizontal_Banners_Small_1_Items_Section_22: true,
    }));
  };
        ...
        <div className="flex items-center justify-between space-x-8">
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            <input
              ...
              role="checkbox"
              tabIndex="0"
              checked={toggleStates.horizontal_Banners_Small_1_Items_Section_22}
              onChange={() =>
                handleToggle("horizontal_Banners_Small_1_Items_Section_22")
              }
            />
            <label htmlFor="horizontalBanners09Status"></label>
          </div>
        </div>

        {toggleStates.horizontal_Banners_Small_1_Items_Section_22 && (
          <>
            <div className="mt-4" id="horizontalBanners09Content">
