...
export default function Home_Page_Section__13() {
  ...
  // Filter banners for layoutNumber 13
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 13
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 13, // ✅ This should be 13 for section 13
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      horizontal_Banners_Large_1_Item_Section_13: true,
    }));
  };
        ...
        <div className="flex items-center justify-between space-x-8">
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            <input
              ...
              role="checkbox"
              tabIndex="0"
              checked={toggleStates.horizontal_Banners_Large_1_Item_Section_13}
              onChange={() =>
                handleToggle("horizontal_Banners_Large_1_Item_Section_13")
              }
            />
            <label htmlFor="horizontalBanners05Status"></label>
          </div>
        </div>

        {toggleStates.horizontal_Banners_Large_1_Item_Section_13 && (
          <>
            <div className="mt-4" id="horizontalBanners05Content">
