...
// export default function Home_Page_Section__19() {
...
//               role="checkbox"
//               tabindex="0"
//               checked={toggleStates.horizontal_Banners_Large_1_Items_Section_19}
//               onChange={() =>
//                 handleToggle("horizontal_Banners_Large_1_Items_Section_19")
//               }
//             />
...
//         {toggleStates.horizontal_Banners_Large_1_Items_Section_19 && (
//           <>
//             <div
//               className="mt-4"
//               id="horizontalBanners08Content"
//               style={{ display: "block" }}
//             >
...
//                   onClick={() =>
//                     toggleModal("horizontal_Banners_Large_1_Items_Section_19")
//                   }
//                 >
//                   <svg
...
export default function Home_Page_Section__19() {
  ...
  // Filter banners for layoutNumber 19
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 19
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 19, // ✅ This should be 19 for section 19
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      horizontal_Banners_Large_1_Items_Section_19: true,
    }));
  };
  ...
  return (
    <>
      ...
      <div className="px-4 py-5 bg-white rounded-lg shadow sm:p-6">
        <div className="flex items-center justify-between space-x-8">
          <label
            htmlFor="horizontalBanners08Status"
            className="text-lg font-medium leading-6 text-gray-900 cursor-pointer"
          >
            Horizontal Banners - Large - 1 Item &nbsp;
            <span className="badge-success">(Layout 19)</span>
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            ...
            />
            <label htmlFor="horizontalBanners08Status"></label>
          </div>
        </div>

        {toggleStates.horizontal_Banners_Large_1_Items_Section_19 && (
          <>
            <div className="mt-4" id="horizontalBanners08Content">
              <div className="flex flex-col">
                <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <div className="overflow-x-hidden overflow-y-auto border border-gray-200 rounded-lg max-h-80">
