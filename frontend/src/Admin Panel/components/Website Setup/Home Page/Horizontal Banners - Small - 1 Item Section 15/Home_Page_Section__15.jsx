...
export default function Home_Page_Section__15() {
  ...
  // Filter banners for layoutNumber 15
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 15
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 15, // ✅ This should be 15 for section 15
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      horizontal_Banners_Small_1_Item_Section_15: true,
    }));
  };
        ...
        <div className="flex items-center justify-between space-x-8">
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            <input
              ...
              role="checkbox"
              tabIndex="0"
              checked={toggleStates.horizontal_Banners_Small_1_Item_Section_15}
              onChange={() =>
                handleToggle("horizontal_Banners_Small_1_Item_Section_15")
              }
            />
            <label htmlFor="horizontalBanners06Status"></label>
          </div>
        </div>

        {toggleStates.horizontal_Banners_Small_1_Item_Section_15 && (
          <>
