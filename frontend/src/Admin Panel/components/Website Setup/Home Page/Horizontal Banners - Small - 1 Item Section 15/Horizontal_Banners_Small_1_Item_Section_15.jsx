...
export default function Horizontal_Banners_Small_1_Item_Section_15() {
  const { isOpenPopupModal, setIsOpenPopupModal } = useAdminGlobalContext();
  useSelect2AndList();
  return (
    <>
      {/* [HOME PAGE SECTION 14] Horizontal Banners - Small - 1 Item IN SECTION 14  */}
      <div
        className={`modal ${
