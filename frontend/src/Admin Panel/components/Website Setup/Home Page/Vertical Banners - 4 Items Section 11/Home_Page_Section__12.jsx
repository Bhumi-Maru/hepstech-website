...
export default function Home_Page_Section__12() {
  ...
  // Filter banners for layoutNumber 12
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 12
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 12, // ✅ This should be 12 for section 12
        ...
        <div className="flex items-center justify-between space-x-8">
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            <input
              ...
              role="checkbox"
              tabIndex="0"
              checked={toggleStates.vertical_Banners_4_Items}
              onChange={() => handleToggle("vertical_Banners_4_Items")}
            />
            <label htmlFor="verticalBanners01Status"></label>
          </div>
        </div>

        {toggleStates.vertical_Banners_4_Items && (
          <>
            <div className="mt-4" id="verticalBanners01Content">
