...
export default function Home_Page_Section__21() {
  ...
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 21
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 21, // ✅ This should be 21 for section 21
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      vertical_Banners_4_Items_Section_21: true,
    }));
  };
        ...
        <div className="flex items-center justify-between space-x-8">
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            <input
              ...
              role="checkbox"
              tabIndex="0"
              checked={toggleStates.vertical_Banners_4_Items_Section_21}
              onChange={() =>
                handleToggle("vertical_Banners_4_Items_Section_21")
              }
            />
            <label htmlFor="verticalBanners03Status"></label>
          </div>
        </div>

        {toggleStates.vertical_Banners_4_Items_Section_21 && (
          <>
            <div className="mt-4" id="verticalBanners03Content">
