...
export default function Home_Page_Section_5() {
  ...
  // Filter banners for layoutNumber 5
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 5
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 5, // ✅ This should be 3 for section 3
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      horizontal_Banners_3_Items: true,
    }));
  };
      ...
      <div className="px-4 py-5 bg-white rounded-lg shadow sm:p-6">
        <div className="flex items-center justify-between space-x-8">
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            ...
            />
            <label htmlFor="horizontalBanners02Status"></label>
          </div>
        </div>

        {toggleStates.horizontal_Banners_3_Items && (
          <>
            <div className="mt-4" id="horizontalBanners02Content">
