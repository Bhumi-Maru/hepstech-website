...
export default function Home_Page_Section_10() {
  ...
  // Filter banners for layoutNumber 10
  const sectionBanners = homePage.filter(
    (banner) => banner.home_page_layout_number?.layoutNumber === 10
  );
  ...
  const handleAddNew = () => {
    ...
    setFormData((prev) => ({
      ...prev,
      layoutNumber: 10, // ✅ This should be 10 for section 10
    ...
    setIsOpenPopupModal((prev) => ({
      ...prev,
      Horizontal_Banners_2_Items: true,
    }));
  };
        ...
        <div className="flex items-center justify-between space-x-8">
          ...
          <div className="flex-shrink-0 ml-4 toggle-switch">
            <input
              ...
              role="checkbox"
              tabIndex="0"
              checked={toggleStates.Horizontal_Banners_2_Items}
              onChange={() => handleToggle("Horizontal_Banners_2_Items")}
            />
            <label htmlFor="horizontalBanners04Status"></label>
          </div>
        </div>

        {toggleStates.Horizontal_Banners_2_Items && (
          <>
