...
export default function Footer_Section_5() {
  ...
  // Provide a safe default if socialMediaLinks is undefined
  const socialMediaLinks = footerFormData.socialMediaLinks || {
    Facebook: "",
    Twitter: "",
    Instagram: "",
    LinkedIn: "",
              ...
              <div key={platform.name}>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    ...
                    name={`socialMediaLinks.${platform.name}`}
                    className="!pl-10 w-full"
                    placeholder={`https://${platform.name.toLowerCase()}.com/yourpage`}
                    value={socialMediaLinks[platform.name] || ""}
                    onChange={(e) =>
                      handleInputChange(
