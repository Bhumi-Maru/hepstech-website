...
export default function Product_Reviews_2() {
  return (
    <>
      {/* PRODUCTS REVIEWS [Product Table] */}
      <div class="mt-4" id="reviewsView">
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed custom-table">
                  <thead>
                    <tr>
                      ...
                      <th>Sub Title</th>
                      <th class="nowrap">Rating Star</th>
                      <th>Comment</th>
                  ...
                  <tbody class="divide-y divide-gray-200 list">
                    <tr>
                      ...
                      <td class="">
                        <div class="flex items-center space-x-3">
                          <div class="flex items-center justify-center flex-none w-12 h-12 overflow-hidden bg-gray-200 rounded-md">
                            <svg
                      ...
                      <td class="nowrap customer-name">Timothy Upshaw</td>
                      <td class="nowrap">Aenean ut tellus tellus</td>
                      <td class="nowrap">
                      ...
                      <td>
                        Suspendisse potenti. Nullam tincidunt lacus tellus, sed
                        aliquam est vehicula a.
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td class="">
                        <div class="flex items-center space-x-3">
                          <div class="flex items-center justify-center flex-none w-12 h-12 overflow-hidden bg-gray-100 rounded-md">
                            <img
                      ...
                      <td class="nowrap customer-name">Weston Perryman</td>
                      <td class="nowrap">Morbi in lacinia metus</td>
                      <td class="nowrap">
                        <div class="flex items-center">
                          <svg
                            class="w-5 h-5 text-yellow-400"
        ...
        <div class="flex flex-col items-center mt-8 sm:mt-4 sm:flex-row sm:justify-between">
          <p class="text-gray-700 showing">
            ...
            <span id="page-last-item-number">2</span> of{" "}
            <span id="totalReviews">2</span> reviews
          </p>
