...
export default function Application_Setting_2() {
  return (
    <>
                ...
                <div>
                  ...
                  <div className="flex items-center mt-2 space-x-8">
                    <div className="flex items-center">
                      <input
                        type="radio"
                        id="appHeaderTextColorBlack"
                        name="appHeaderTextColor"
                        className=""
                      />
                      <label for="appHeaderTextColorBlack" className="ml-3">
                        Black
                      </label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        type="radio"
                        id="appHeaderTextColorWhite"
                        name="appHeaderTextColor"
                        className=""
                      />
                      <label for="appHeaderTextColorWhite" classNameName="ml-3">
                        White
                      </label>
                    </div>
                  </div>
