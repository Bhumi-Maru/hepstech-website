...
export default function Website_Settings_3() {
  return (
    <>
      {/* WEBSITE SECTION SECTION [Header] */}
                  ...
                  <div className="flex items-center mt-2 space-x-8">
                    <div className="flex items-center">
                      <input
                        ...
                        className=""
                      />
                      <label for="headerTextColorBlack" className="ml-3">
                        Black
                      </label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className=""
                      />
                      <label for="headerTextColorWhite" className="ml-3">
                        White
                      </label>
                    </div>
                  </div>
